...
public class MapSerializer implements Serializer, Opcodes {
    ...
    public void compile(Type type, MethodVisitor mv, AsmSerializerContext context) {
		...
		Label l8 = new Label();
		mv.visitLabel(l8);
		mv.visitFrame(Opcodes.F_FULL, 9, new Object[] {"transfer/serializer/MapSerializer", "transfer/Outputable", "java/lang/Object", "transfer/utils/IdentityHashMap", "java/util/Map", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
		...
		if ((keyClass == null || keyClass == Object.class)) {
            ...
            Type keyType = TypeUtils.getParameterizedType((ParameterizedType) type, 0);
		...
		if (valueClass == null || valueClass == Object.class) {
            ...
            Serializer fieldSerializer = TransferConfig.getSerializer(valueClass);
            
            Type valueType = TypeUtils.getParameterizedType((ParameterizedType) type, 1);
