...
public class ShortStringSerializer implements Serializer, Opcodes {
    ...
    public void compile(Type type, MethodVisitor mv, AsmContext context) {
        ...
        mv.visitMethodInsn(INVOKESTATIC, "transfer/utils/BitUtils", "putInt1", "(Ltransfer/Outputable;I)V", false);
        
        mv.visitVarInsn(ALOAD, 1);
        mv.visitVarInsn(ALOAD, 6);
        mv.visitMethodInsn(INVOKEINTERFACE, "transfer/Outputable", "putBytes", "([B)V", true);
