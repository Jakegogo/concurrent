...
public class ArraySerializer implements Serializer, Opcodes {
    ...
    public void compile(Type type, MethodVisitor mv, AsmContext context) {
        ...
        Class<?> componentClass = TypeUtils.getRawClass(type).getComponentType();
        ...
        if (componentClass == null || componentClass == Object[].class) {
	        ...
	        mv.visitFrame(Opcodes.F_FULL, 9, new Object[] {"transfer/serializer/ArraySerializer", "transfer/Outputable", "java/lang/Object", "transfer/utils/IdentityHashMap", "[Ljava/lang/Object;", Opcodes.TOP, Opcodes.INTEGER, Opcodes.INTEGER, "[Ljava/lang/Object;"}, 0, new Object[] {});
            ...
            Serializer fieldSerializer = TransferConfig.getSerializer(componentClass);
