...
public class SimpleOrderedThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public SimpleOrderedThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue, utils.thread.RejectedExecutionHandler handler) {
        super(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, handler);
    }

    public SimpleOrderedThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue, ThreadFactory threadFactory, utils.thread.RejectedExecutionHandler handler) {
	...
	protected final class Worker implements Runnable {
        ...
        private void runTask(Runnable task) {
            ...
            try {
                 ...
                 * exceptions. Otherwise, the caught runtime exceptions
