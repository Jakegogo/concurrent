 ...
 */
package basesource.convertor.files.monitor;
...
public class FileAlterationObserver implements Serializable {
     ...
     */
    public FileAlterationObserver(String directoryName, boolean circulate) {
        this(new File(directoryName), circulate);
    }
     ...
     */
    public FileAlterationObserver(String directoryName, FileFilter fileFilter, boolean circulate) {
        this(new File(directoryName), fileFilter, circulate);
    }
     ...
     */
    public FileAlterationObserver(String directoryName, FileFilter fileFilter, IOCase caseSensitivity, boolean circulate) {
        this(new File(directoryName), fileFilter, caseSensitivity, circulate);
    }
     ...
     */
    public FileAlterationObserver(File directory, boolean circulate) {
        this(directory, (FileFilter)null, circulate);
    }
     ...
     * @param fileFilter The file filter or null if none
     */
    public FileAlterationObserver(File directory, FileFilter fileFilter,boolean circulate) {
        this(directory, fileFilter, (IOCase)null, circulate);
    }
     ...
     * @param caseSensitivity  what case sensitivity to use comparing file names, null means system sensitive
     */
    public FileAlterationObserver(File directory, FileFilter fileFilter, IOCase caseSensitivity, boolean circulate) {
        this(new FileEntry(directory), fileFilter, caseSensitivity, circulate);
    }
